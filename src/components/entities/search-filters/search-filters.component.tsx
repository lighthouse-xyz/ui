...
import { EntityType, RelationshipToOwner, World } from "@src/common/graphql/generated/discovery.schema.graphql";
...
const SearchFilters: React.FC = () => {
  ...
  const { filtersSelected, setFiltersSelected, setPage } = useSearchPageContext();
  ...
  const listFilters: FilterList[] = [
    ...
    },
    {
      ...
      filterOptions: getMenuOptionArrayFromEnum(
        EntityType,
        FilterCategory.type,
        vrMode ? [EntityType.member] : undefined,
      ),
    },
